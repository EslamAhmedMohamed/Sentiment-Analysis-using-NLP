...
def read_data(folders):
    ...
    for folder in folders:
        ...
        folder_path = os.path.join('C:\\Users\\go\\Desktop\\review_polarity\\txt_sentoken', folder)
...
# function that takes the dataframe and the training and validation data as parameters
def extract_features(df, train_x, valid_x):
    
    # create a TF-IDF vectorizer object
    # r'\w{1,}'-> one or more  consecutive word characters,max feature =5000 -> vectorizer should use the top 5000 most frequent words as features.
...
#feature_vector_train -> Xtrain
#label-> y train
#feature_vector_valid -> x test
